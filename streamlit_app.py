...
st.write("Selamat datang di platform pembelajaran interaktif Fisika Inti. Yuk, pelajari konsep dasar energi nuklir dengan cara yang seru dan mudah dipahami! 💡")

# ==========================
# Navigasi Sidebar
# ==========================
menu = st.sidebar.radio("Pilih Menu:", ["🏠 Beranda", "📘 Materi", "📊 Visualisasi", "🧩 Kuis", "ℹ️ Tentang"])
...
if menu == "🏠 Beranda":
    ...
    st.write("""
    Fisika inti adalah cabang ilmu fisika yang mempelajari struktur dan sifat-sifat inti atom serta interaksi antar partikel di dalamnya.  
    Ilmu ini menjadi dasar bagi teknologi nuklir, baik dalam bidang energi, kesehatan, maupun penelitian ilmiah.  
    Di LMS ini, kamu bisa belajar dua submateri penting:
    - Manfaat dan Dampak Energi Nuklir  
    - Prinsip Reaksi Fisi dan Fusi
    """)
...
# ==========================
    ...
    st.info("Grafik menunjukkan bahwa inti ringan cenderung mengalami fusi, sedangkan inti berat cenderung mengalami fisi.")
...
# ==========================
    ...
    if st.button("💯 Lihat Skor Akhir"):
        ...
        if skor == 3:
            st.balloons()
            st.success("Keren banget broo! Kamu udah jago banget di Fisika Inti! 🔥")
        elif skor == 2:
...
# ==========================
    ...
    st.header("Tentang LMS Fisika Inti")
    st.write("""
    ...
    - 🌐 Siap dijalankan di Streamlit Cloud atau GitHub Pages
    """)
